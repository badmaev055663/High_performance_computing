...
/* matrix-vector multimplication by columns using omp
   matrix size - [m, n]
   vector size - [n]
*/
...
// block matrix-vector multiplication for omp
...
/* block matrix-vector multiplication 
   assume n is even and n is divided by number of threads 
*/
...
/* sequential matrix-vector multimplication by definition
   matrix size - [m, n]
   vector size - [n] 
*/
...
/* parallel multiplication of matrices using omp with row splitting
  mat1 [m, n] and mat2 [n, k] 
*/
...
// block square matrix multiplication for omp
...
/* block matrix-vector multiplication
   assume mat1 and mat2 are square, n is even 
*/
int** matrix_matrix_omp_block(int** mat1, int** mat2, int n, double& dt)
{
	...
	const int block_num = 8; // number of basic block multiplications 
	double t1 = omp_get_wtime();
...
// sequential multiplication of mat1 [m, n] and mat2 [n, k] by definition
...
//generate random matrix of size [m, n]
...
int main()
{
	...
	const int count = 5;
	printf("enter size for matrix-vector test:");
	std::cin >> vector_test_size;
	printf("enter size for matrix-matrix test: ");
